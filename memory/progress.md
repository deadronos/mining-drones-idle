...
- **2026-01-18**: Started TASK060 (Shadcn UI Overhaul).
  ...
  - Added a mission-control header over the main R3F canvas and began updating global shell styles.
...
- Evaluate extending sampling-status cues beyond the inspector (e.g., HUD toast or Settings confirmation) for better visibility.
