...
2025-10-30: Surfaced last-sample timing in metrics banner using game-time deltas and extended FactoryMetricsTab test coverage. Validation: npm run typecheck, npm run lint, npm run test (211 tests).
