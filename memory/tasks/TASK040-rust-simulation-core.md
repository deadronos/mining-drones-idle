...
| 2.1 | Scaffold Rust crate with RNG, schema, layout, API       | In Progress | 2025-11-18 | Crate + tests landing in this change. |
| 2.2 | Create TS wasm bridge contract and helpers              | In Progress | 2025-11-18 | Bridge stub added without runtime wiring. |
| 3.1 | Plan wasm-bindgen/feature-flag integration              | Not Started | 2025-11-18 | To follow once crate stabilizes. |
